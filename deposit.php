  ...
  <div class="container-scroller">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
              <div class="navbar-profile">
                ...
                <p class="mb-0 d-none d-sm-block navbar-profile-name" data-toggle="dropdown"><i class="fas fa-user-cog"></i>&nbsp;Hi! <?= $fname; ?></p>
              ...
              <a class="dropdown-item preview-item">
                ...
                <div class="preview-item-content">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="assets/php/logout.php">Log Out </a></li>
                  </ul>
                </div>
              </a>
              <div class="dropdown-divider"></div>
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="pages/withdraw.php">
            <span class="menu-icon">
                ...
                <form name="myform" class="currency_validate">
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="text" name="usd_amount" class="form-control" value="350.00 USD">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="usd_amount" class="form-control" placeholder="350.00 USD">
                    </div>
...
-->
         <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="page-title"> Select Your Wallet for Payment </h3>
                    <p class="card-description"></p>
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputName1">1GaNuTT5hkFRR822P2hnaiGYKCNTqth9Kq</label>
                        <p class="card-description"> BITCOIN WALLET ADDRESS </p>
                      </div>
                        <div class="form-group">
                        <label for="exampleInputName1">0x82ddaf43636236c2971d1f53d4ef3543ac552ea2</label>
  ...
  <footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
      <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © DashboardPack 2022<br>
      </span>
    </div>
  </footer>
  <!-- partial -->
