...
<body>
                    ...
                    <form action="#" method="post" class="px-3" id="register-form">
                        ...
                        <div class="input-group input-group-lg form-group">
                         ...
                         <div class="input-group input-group-lg form-group">
                            ...
                            <input type="password" name="password" id="rpassword" class="form-control rounded-0" placeholder="Password" required minlength>
                        </div>
  ...
  <div class="row justify-content wrapper" id="forgot-box" style="display: none;">
        <div class="col-lg-10 my-auto">
            <div class="card-group myShadow">
                 <div class="card justify-content-center rounded-left myColor p-4">
